...
const FAQ = [
  { q: "Peut-on automatiser une piscine existante ou seulement les nouvelles installations ?", a: "Une automatisation (régulation pH/Rx, pompes doseuses, contre-lavage automatique) se greffe sur la grande majorité des installations existantes dès lors qu'il existe un by-pass sur le circuit de filtration. Aucune rénovation structurelle n'est nécessaire. Nous évaluons la faisabilité lors d'une visite préalable gratuite." },
  { q: "Combien coûte une installation d'automatisation complète ?", a: "Un système de régulation pH/Rx avec pompes doseuses et tableau de bord à distance est facturé entre 2 500 et 5 500 CHF fourni-posé, selon le matériel choisi (Bayrol Poolmanager, OSF, Speck Badu) et la complexité de l'installation existante. Une pompe à vitesse variable s'ajoute pour 1 500–3 500 CHF. Le retour sur investissement moyen est de 2 ans sur les seuls coûts d'énergie." },
