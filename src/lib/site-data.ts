...
export const ZONES: Zone[] = [
  {
    ...
    faq: [
      { q: "Combien coûte une mise en service printemps à Estavayer-le-Lac ?", a: "Une mise en service standard comprend le contrôle de l'installation, l'équilibrage chimique et la remise en route des équipements. Tarif orientatif : 180–350 CHF selon la complexité. Devis gratuit après une première visite." },
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Combien coûte l'automatisation d'une piscine à Morat ?", a: "Une installation de régulation pH/Rx avec pompes doseuses est facturée entre 2 500 et 5 000 CHF selon le matériel choisi. L'ajout d'une pompe à vitesse variable représente 1 500–3 500 CHF supplémentaires. La rentabilité moyenne est de 2 ans sur les coûts d'énergie." },
  ...
  },
  {
    ...
    faq: [
      { q: "Combien coûte un entretien saisonnier bi-mensuel autour de Lucens ?", a: "Un contrat bi-mensuel couvre la mise en service, les visites toutes les deux semaines pendant la saison et la mise en hivernage. Tarif indicatif : 1 200–1 800 CHF la saison selon le volume et l'équipement. Devis précis sur demande." },
